...
public class LeadValidatorUseCase implements PromoteLeadUseCase {
     ...
     * This is the main orchestration method that coordinates the validation and
     * promotion process.
     *
    ...
    private Mono<LeadValidationResult> handleRejectedLead(Lead lead, LeadValidationResult validationResult) {
        ...
        return this.leadRepository.save(lead)
                .map(savedLead -> {
                    ...
                    kafkaLeadPromotedProducer.sendLeadToKafka(AvroMappers.leadToLeadRejectedEvent(savedLead));
     ...
     * @param validationResult The validation result
     * @return A Mono containing the validation result, or empty if no existing lead
     *         found
     */
     ...
     * @return A Mono containing the updated validation result
     */
    private Mono<LeadValidationResult> updateExistingLeadToProspect(Lead existingLead,
            LeadValidationResult validationResult) {
        ...
        return this.leadRepository.save(updatedLead)
                .map(savedLead -> {
                    ...
                    kafkaLeadPromotedProducer.sendLeadToKafka(AvroMappers.leadToLeadPromotedAvroEvent(savedLead));
                    return validationResult.withLead(savedLead);
                });
    }
